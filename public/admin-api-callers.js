...
export async function viewAdminNotificationsAPICaller(){
  try{
    ...
    const data = await response.json();
       ...
       if(data.tokenExpired){
          ...
          if(data2.success){
            const response3 = await fetch(`${API_URL}/admin/notifications`, {
              method: "GET",
              credentials: "include",
              headers: {
               "Content-Type": "application/json"
...
export async function addWalkinAPICaller(day_time){
  try{
    ...
    const data = await response.json();
       ...
       if(data.tokenExpired){
          ...
          if(data2.success){
            const response3 = await fetch(`${API_URL}/admin/appointments`, {
              method: "POST",
              credentials: 'include',
              headers: {
               "Content-Type": "application/json"
  ...
  try{
    ...
    const data = await response.json();
       ...
       if(data.tokenExpired){
          ...
          if(data2.success){
            const response3 = await fetch(`${API_URL}/admin/dashboard`, {
             method: "GET",
             credentials: "include",
             headers: {
               "Content-Type": "application/json"
